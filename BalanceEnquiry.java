...
public class BalanceEnquiry extends JFrame implements ActionListener
 {
    ...
    public BalanceEnquiry(int atno1,int acno1,int pno1,String actype1)
    {
		...
		l7=new JLabel("Thank You For Banking With Pakistan BANK.For more information,");
		l7.setFont(f);
		l7.setForeground(Color.RED);
		l7.setBounds(50,450,650,20);jf.add(l7);

		l8=new JLabel("Please call Toll Free No:1800 2000 1911  or  Visit www.Pakistanbank.com ");
		l8.setFont(f);
